...
var (
	...
	counterIncrementedNumIndexed = int(1)
)
...
func MatchCounterIncremented(l abi.Log) (CounterIncremented, bool) {
	...
	if len(l.Topics) != counterIncrementedNumIndexed {
		return CounterIncremented{}, false
	}
...
var (
	...
	orderCancelledNumIndexed = int(2)
)
...
var (
	...
	orderFulfilledNumIndexed = int(2)
)
...
func MatchOrderFulfilled(l abi.Log) (OrderFulfilled, bool) {
	...
	if len(l.Topics) != orderFulfilledNumIndexed {
		return OrderFulfilled{}, false
	}
...
var (
	...
	orderValidatedNumIndexed = int(0)
)
...
func MatchOrderValidated(l abi.Log) (OrderValidated, bool) {
	...
	if len(l.Topics) != orderValidatedNumIndexed {
		return OrderValidated{}, false
	}
